...
class App:
    def __init__(self):
        ...
        self.login_button_main_window.place(x=800, y=200)

        self.logout_button_main_window = util.get_button(self.main_window, 'logout', 'red', self.logout)
        self.logout_button_main_window.place(x=800, y=300)
    ...
    def register_new_user(self):
        ...
        self.register_new_user_window.geometry("1200x550")
        ...
        self.accept_button_register_new_user_window.place(x=800, y=300)
        ...
        self.try_again_button_register_new_user_window.place(x=800, y=400)
        ...
        self.entry_text_register_new_user.place(x=800, y=150)

        self.text_label_register_new_user = util.get_text_label(self.register_new_user_window,
                                                                'Enter username:')
        self.text_label_register_new_user.place(x=800, y=100)
